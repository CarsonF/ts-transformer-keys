...
function visitNode(node, program) {
    ...
    return typescript_1.default.factory.createArrayLiteralExpression(properties.map(function (property) { return typescript_1.default.factory.createStringLiteral(property.name); }));
}
